...
namespace EpicToonFX
{
    public class ETFXEffectControllerPooled : MonoBehaviour
    {
        ...
        private IEnumerator EffectLoop()
        {
            ...
            if (currentEffect.GetComponent<AudioSource>())
            {
                currentEffect.GetComponent<AudioSource>().volume = 0.5f;
                //currentEffect.GetComponent<AudioSource>().enabled = PrefSaver.instance.OnSound;
            }
