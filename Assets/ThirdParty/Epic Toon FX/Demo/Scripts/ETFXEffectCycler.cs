...
namespace EpicToonFX
{
	public class ETFXEffectCycler : MonoBehaviour
	{
		...
		private IEnumerator EffectLoop()
		{
			...
			if (instantiatedEffect.GetComponent<AudioSource>())
			{
				instantiatedEffect.GetComponent<AudioSource>().volume = 0.5f;
				//instantiatedEffect.GetComponent<AudioSource>().enabled = PrefSaver.instance.OnSound;
			}
