...
namespace EpicToonFX
{
	public class ETFXLoopScript : MonoBehaviour
	{
		...
		IEnumerator EffectLoop()
		{
			...
			if (effectPlayer.GetComponent<AudioSource>())
			{
				effectPlayer.GetComponent<AudioSource>().volume = 0.5f;
				//effectPlayer.GetComponent<AudioSource>().enabled = PrefSaver.instance.OnSound;
			}
