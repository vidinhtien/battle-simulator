...
{
    public class CrusaderHandAttack : AttackPerSecondsBehaviour_TwoMeleeWeapon
    {
        ...
        IEnumerator Punch(MuscleData upperArmMuscle, MuscleData lowerArmMuscle, MuscleData handMuscle, MeleeWeapon punch)
        {
            ...
            punch.Rigidbody.AddForce(direction.normalized * 60, ForceMode.VelocityChange);
            handMuscle.Rigidbody.AddForce(direction.normalized * 50, ForceMode.VelocityChange);
            lowerArmMuscle.Rigidbody.AddForce(direction.normalized * 40, ForceMode.VelocityChange);
            ...
            var tweener = DOVirtual.Float(0, 1, 1f, v =>
            {
