...
namespace ZeroX.RagdollSystem.MonoEditors
{
    ...
    [AddComponentMenu("ZeroX/Ragdoll System/Ragdoll Manager/Biped Ragdoll Creator")]
    public class BipedRagdollCreator : RagdollCreator
    {
        ...
        public struct Options
        {
            ...
            [Header("Joints")]
            [HideInInspector] public JointType joints;
            ...
            public static Options Default
            {
                get
                {
                    ...
                    o.joints = JointType.Configurable;
                    o.jointRange = 1f;
                    ...
                    o.feet = true;
                    o.footColliders = ColliderType.Capsule;
